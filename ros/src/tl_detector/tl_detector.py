...
class TLDetector(object):
    ...
    def image_cb(self, msg):
        ...
        if self.state != state:
            self.state_count = 0
            self.state = state
        elif self.state_count >= STATE_COUNT_THRESHOLD: #confirm the detection results
    ...
    def get_closest_waypoint(self, x, y):
        ...
        """
        #TODO implement
        #get closest waypoint using kdtree
    ...
    def process_traffic_lights(self):
        ...
        if(self.pose):
            ...
            # rospy.loginfo("Nearest self positon idx:{}".format(car_wp_idx))

            #find the closet visible traffic light(if one exists)
