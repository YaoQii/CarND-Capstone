...
class WaypointUpdater(object):
    def __init__(self):
        ...
        self.pose = None
        #self.base_waypoints = None #replace by base_lane
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            if self.pose and self.base_lane:
                ...
                #move it in self.generate_lane in final
    ...
    def get_closest_waypoint_id(self):
        ...
        #equation fro hyperplane through cloest_coord
    ...
    def decelerate_waypoints(self, waypoints, closest_idx):
        ...
        for i, wp in enumerate(waypoints):
            ...
            #two waypointts back from line so fromt of car stops at line
            #2: the centre of car
